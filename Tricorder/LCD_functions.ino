...
{
  Serial.println(F("Starting Tricorder"));
  ...
  lcd.clear();
  lcd.setCursor (0, 0);
  lcd.print(F("Place probe in"));
  lcd.setCursor (0, 1);
  lcd.print(F("the ground..."));
}
...
void initialLCDState()
{
  ...
  lcd.clear();
  lcd.setCursor(0, 0);
  lcd.print(F("Taking a reading..."));                //LCD shows message
}
